...
export const getSuggestions = async (query) => {
    let suggestions = [];
    const suggestionHandlers = [getMappingsSuggestions, getBookmarkSuggestions];
    for (const handler of suggestionHandlers) {
        try {
            suggestions = suggestions.concat(await handler(query));
        } catch (error) {
